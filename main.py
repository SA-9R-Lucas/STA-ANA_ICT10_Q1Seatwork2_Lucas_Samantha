...
# List data type
product_names = ["Red Velvet Cookie", "Chocolate Chip Cookie", "Matcha Cookie"]
beverages = ["Matcha Latte", "Espresso"]
...
menu = {
    "Red Velvet Cookie": 150.00,
    "Chocolate Chip Cookie": 130.00,
    "Matcha Cookie": 150.00,
    "Matcha Latte": 140.00,
    "Espresso": 80.00
}
